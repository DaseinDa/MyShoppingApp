...
public class UserOrderStateAdapter extends BaseAdapter {
     //数据源
    private List<OrderInfo> mList = new ArrayList<>();

    private Context mContext;
    public UserOrderStateAdapter(Context context, List<OrderInfo> m) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.moreTxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(mContext,UserOrderStateGoodsListActivity.class);
